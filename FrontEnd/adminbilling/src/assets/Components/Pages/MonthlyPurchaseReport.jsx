...
import { FaCalendar, FaCalendarAlt, FaFileInvoice, FaCube, FaChartBar, FaRupeeSign, FaPercentage, FaPlay } from "react-icons/fa";
import { usePurchaseReport } from "../States/PurchaseReportContext";

const MonthlyPurchaseReport = () => {
  const [fromDate, setFromDate] = useState("");
  const [toDate, setToDate] = useState("");
  const { monthlyRows: rows, loadMonthly, loading } = usePurchaseReport();
  ...
  const handleGenerate = async () => {
    ...
    await loadMonthly({ fromDate, toDate });
  };
